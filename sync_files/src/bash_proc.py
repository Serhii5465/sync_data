...
def get_cmd_output(command):
    ...
    Wait for command to complete, then return instance of [CompletedProcess] class.
    Parameter [capture_output] is responsible for capture stdout/stderr and store their
    outputs in variable.
    Parameter [text=True] interpreters outputs stdout/stderr like as human-readable format.
    Default value [text] = False, and it means all inputs/output is accepted as binary data.
    :param command: array which contains name Unix utility and her arguments execution
